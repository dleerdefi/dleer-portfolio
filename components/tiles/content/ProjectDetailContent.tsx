  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border-b pb-4" style={{ borderColor: 'var(--theme-border)', opacity: 0.3 }}>
        <h1 className="text-2xl font-bold" style={{ color: 'var(--accent-color)' }}>{fullProject.name}</h1>
      ...
      <div className="space-y-4" style={{ color: 'var(--theme-text)' }}>
        ...
        {fullProject.metrics && fullProject.metrics.length > 0 && (
          <div>
            <h2 className="text-lg font-bold mb-3" style={{ color: 'var(--accent-color)', opacity: 0.9 }}>Key Metrics & Impact</h2>
        ...
        {fullProject.videoUrl && (
          <div>
            <h2 className="text-lg font-bold mb-3" style={{ color: 'var(--accent-color)', opacity: 0.9 }}>Video Demo</h2>
            <div className="p-3 rounded-lg border" style={{
              borderColor: 'rgba(var(--accent-color-rgb), 0.3)',
              backgroundColor: 'rgba(var(--theme-surface-rgb), 0.2)'
            }}>
              <p className="text-sm mb-2" style={{ color: 'var(--theme-text-dimmed)' }}>
        ...
        <div className="flex gap-3" style={{ paddingTop: '32px' }}>
          {fullProject.github && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="touch-target touch-feedback px-4 py-2 text-sm rounded hover:opacity-90 transition-all duration-200 inline-block"
              style={{ backgroundColor: 'var(--accent-color)', color: 'var(--theme-bg)', textDecoration: 'none' }}
            >
          ...
          {fullProject.demo && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="touch-target touch-feedback px-4 py-2 border text-sm rounded transition-all duration-200 inline-block"
              style={{
