...
<Admonition type="warn" title="The AI Trap">
AI makes it tempting to skip straight to prompting. You'll get **800 lines in minutes**, then spend the next **48 hours** spamming "pls fix" for errors in code you didn't design.

**Velocity collapses by week two.**
</Admonition>
...
<Admonition type="tip" title="The Golden Rule">
When changes occur, **update the SPEC first**, then the code.

Never let the code drift from the spec. The spec is the architectural drawing—your agent is the general contractor.
</Admonition>
...
<Admonition type="note" title="Why This Works">
...
<Admonition type="tip" title="The Best Problem">
...
<Admonition type="tip" title="Think Like a Builder">
Pour a solid foundation (spec), frame the structure (milestones), wire the systems (implementation), finish the surfaces (polish).
</Admonition>
