...
I didn't study software in a CS lab. I learned it on muddy jobsites, helping engineer a **$548 million medical campus** where hidden systems like med gas, reverse-osmosis lines and pneumatic tubes—had to mesh perfectly. You learn to think in dependencies and coordination.
...
Years later, as a CPO who regularly ships code, I operate the same way. I call it the **preconstruction mindset**: plan first, then execute in slices. It's the difference between "it works on my machine" and a clean deployment.
